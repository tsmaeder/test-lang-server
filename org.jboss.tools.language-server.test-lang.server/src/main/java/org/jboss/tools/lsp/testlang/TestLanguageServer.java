 ...
 */
public class TestLanguageServer implements ExtendedLanguageServer {
    ...
    public CompletableFuture<InitializeResult> initialize(InitializeParams params) {
        ...
        capabilities.setCompletionProvider(new CompletionOptions(true, Collections.emptyList()));
